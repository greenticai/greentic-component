...
const GREENTIC_TYPES_VERSION: &str = ">=1.2.0-dev, <1.3.0-0";
const GREENTIC_INTERFACES_GUEST_VERSION: &str = ">=1.2.0-dev, <1.3.0-0";
const GREENTIC_INTERFACES_VERSION: &str = ">=1.2.0-dev, <1.3.0-0";
