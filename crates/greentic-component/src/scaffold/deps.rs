...
const GREENTIC_TYPES_VERSION: &str = ">=1.1.0-dev, <1.2.0-0";
const GREENTIC_INTERFACES_GUEST_VERSION: &str = ">=1.1.0-dev, <1.2.0-0";
const GREENTIC_INTERFACES_VERSION: &str = ">=1.1.0-dev, <1.2.0-0";
